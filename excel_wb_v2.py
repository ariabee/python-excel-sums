...
# Define global variable to be used in recursive function
workbooks = []
...
def sum_excel(file_directory):
	...
	print("\nSums of all rows in the workbook directory") 
	print("are stored in the new file, row_sums.csv.")
